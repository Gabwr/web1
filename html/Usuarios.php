...
$consulta = 'SELECT usuario.idUsuario, usuario.nombre, usuario.apellido, 
                    perfil.nombre AS perfil, usuario.ultimaConexion, usuario.estado 
             FROM usuario 
...
while ($registro = mysqli_fetch_assoc($resultado)) {
    ...
    $tabla .= '<td>' . htmlspecialchars($registro['ultimaConexion']) . '</td>';
...
<div class="container">
    <div class="d-flex justify-content-between">
        <h4>Usuarios</h4>
		<button class="btn shadow-sm border-light" onclick="mostrarDialogo()">Agregar Usuario</button>
    </div> 
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="miDialogoLabel">Agregar Usuario</h5>
