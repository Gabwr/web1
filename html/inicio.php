...
<body>
    <section class="d-flex justify-content-center py-3 gap-5 " style=" height: 65vh;">
        <div class="flex-column align-items-center gap-5 w-100 d-flex">
            <div class="col-md-6">
                <div class="p-4 text-white rounded d-flex flex-column justify-content-center align-items-center"
                    style="background-color: #69a84f; min-height: 150px;">
            ...
            <div class="col-md-6">
                <div class="p-4 text-white rounded d-flex flex-column justify-content-center align-items-center"
                    style="background-color: #e69137; min-height: 150px;">
